...
public class SetCommand extends Command {
     ...
     */
    public SetCommand() {
        super(Collections.singletonList("set"), "Set a player' MobCoins", "iridiummobcoins.set", false);
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        if (args.length != 3) {
            sender.sendMessage(StringUtils.color(IridiumMobCoins.getInstance().getConfiguration().prefix + " &7/mc set <player> <amount>"));
            return;
        }
        int amount;
        try {
